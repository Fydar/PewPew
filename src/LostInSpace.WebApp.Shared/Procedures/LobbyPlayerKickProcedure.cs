...
{
	public class LobbyPlayerKickProcedure : NetworkedViewProcedure
	{
		...
		public override void ApplyToView(NetworkedView view)
		{
			...
			view.Lobby.Chat.OnReceiveMessage?.Invoke(new ChatMessage("System", $"\"{character.DisplayName}\" was kicked from the lobby."));
		}
	}
}
